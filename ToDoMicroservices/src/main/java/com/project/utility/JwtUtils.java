    ...
    public String generateJwt(String email, String name, Date date) throws UnsupportedEncodingException {
        String jwt = Jwts.builder()
                ...
                .signWith(
                        ...
                        "ETKEYSECRETKEYSECRETKEYSECRETKEYSECRETKEY".getBytes("UTF-8"))
                .compact();
        return jwt;
    }

    public Map<String, Object> jwt2Map(String jwt) throws UnsupportedEncodingException, ExpiredJwtException {
        Jws<Claims> claim = Jwts.parser()
                .setSigningKey("ETKEYSECRETKEYSECRETKEYSECRETKEYSECRETKEY".getBytes("UTF-8"))
                .parseClaimsJws(jwt);
